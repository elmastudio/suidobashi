...
?>
	...
	<h3 class="blog-title"><?php _e('Images', 'suidobashi') ?></h3>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<header class="entry-header">
				...
				<?php edit_post_link( __( 'Edit', 'suidobashi' ), '<div class="entry-edit">', '</div>' ); ?>
...
?>
	...
	<div class="nav-wrap cf">
		<nav id="nav-single" class="cf">
			<div class="nav-next"><?php next_image_link( '%link', ( '<span>' . __( 'Next Image', 'suidobashi' ) . '</span>' ) ); ?></div>
			<div class="nav-previous"><?php previous_image_link( '%link', ( '<span>' . __( 'Previous Image', 'suidobashi' ) . '</span>' ) ); ?></div>
		</nav><!-- #nav-single -->
	</div><!-- end .nav-wrap -->
